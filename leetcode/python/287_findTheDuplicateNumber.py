...
sol = Solution()
print sol.findDuplicate([1,2,3,4,5,6,5])


'''
In this problem, nums[a] = b can be seen as a.next = b, the the problem is
exactly the same as Linked List Cycle II which finds the node that cycle begins.
